...
class Preprocess():
    ...
    def __init__(self, path_to_babi):
        ...
        self.path_to_processed = "./babi_processed_cq_same"
    ...
    def load_train(self):
        ...
        train_dataset = (train_question_masked, train_answer_index, train_answer_num, train_context_masked, train_label_masked, train_context_real_len, train_question_real_len)
        if not os.path.exists(self.path_to_processed):
            os.makedirs(self.path_to_processed)
    ...
    def load_val(self):
        ...
        val_dataset = (val_question_masked, val_answer_index, val_answer_num, val_context_masked, val_label_masked, val_context_real_len, val_question_real_len)
        if not os.path.exists(self.path_to_processed):
            os.makedirs(self.path_to_processed)
    ...
    def load_test(self):
        ...
        test_dataset = (test_question_masked, test_answer_index, test_answer_num, test_context_masked, test_label_masked, test_context_real_len, test_question_real_len)
        if not os.path.exists(self.path_to_processed):
            os.makedirs(self.path_to_processed)
